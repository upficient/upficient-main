...
import "./SectionWithoutBg.scss";

interface SectionWithourBgProps {
  data: {
    bgSrc?: string;
    imageSrc?: string;
    title?: string;
...
const SectionWithoutBg: React.FC<{ data: any }> = ({ data }) => {
  const {
  ...
  return (
    <section
      className="colorwithoutbgSec"
      style={{
        background: "linear-gradient(4.45deg, #E6E2FF 3.47%, #FFFFFF 82.53%)",
